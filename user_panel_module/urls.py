...
urlpatterns = [
    ...
    path('my-shoppings', views.MyShopping.as_view(), name='user_shopping_page'),
    path('my-shoppings-detail/<order_id>', views.my_shopping_detail, name='user_shopping_detail_page'),
